...
# give powers after 30s
execute if score Timer Timer matches 450 run setblock 58 22 262 minecraft:redstone_block
execute if score Timer Timer matches 449 run setblock 58 22 262 minecraft:air

# give power ups after 30s
#execute if score Timer Timer matches 450 run setblock 58 22 262 minecraft:redstone_block
#execute if score Timer Timer matches 450 run setblock 58 22 262 minecraft:air

# timer stop
execute if score Timer Timer matches ..0 run function has:fa/fastop
